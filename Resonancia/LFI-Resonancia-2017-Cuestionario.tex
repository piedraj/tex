...
\vspace*{0.5cm}
{\normalsize \rm $2^{\underline \rm o}$ CURSO DE GRADO EN F\'ISICA.  2017-2018 }\\
{\normalsize \rm  Laboratorio de F\'isica I}\\ 
{\normalsize \rm  {\bf CUESTIONARIO. Resonancia. } Profesores Julio G\"u\'emez, J\'onatan Piedra}\\
...
\item  Un carrito de carril sin rozamiento, unido a dos muelles,  se encuentra forzado con su frecuencia natural y amortiguado mediante una placa de aluminio que sobresale del carro y que oscila entre dos imanes potentes.   Los dos imanes {\bf se aproximan} a la placa de aluminio. La {\bf frecuencia} $\omega$ de la oscilaci\'on del carro:
\begin{enumerate}
\item[(a)] \fbox{$\, \phantom{-}\, $} \hspace*{1cm}   aumenta
\item[(b)] \fbox{$\, \phantom{-}\, $} \hspace*{1cm}   disminuye
\item[(c)] \fbox{$\, \phantom{-}\, $} \hspace*{1cm}   no var\'ia
\end{enumerate}

\item  Un carrito de carril sin rozamiento unido a dos muelles se encuentra forzado con su frecuencia natural y amortiguado mediante una placa de aluminio que sobresale del carro y que oscila entre dos imanes potentes.   Los dos imanes  {\bf se alejan} de  la placa de aluminio. La {\bf amplitud} $A$ de la oscilaci\'on del carro:
\begin{enumerate}
\item[(a)] \fbox{$\, \phantom{-}\, $} \hspace*{1cm}   aumenta
\item[(b)] \fbox{$\, \phantom{-}\, $} \hspace*{1cm}   disminuye
\item[(c)] \fbox{$\, \phantom{-}\, $} \hspace*{1cm}   no var\'ia
