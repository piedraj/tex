...
In the ATLAS document~\cite{ref:ATLAS-topCrossSection} the inclusive ${\rm t{\bar t}}$
...
paper~\cite{ref:CMS-topCrossSection}, using $5.0~{\rm fb}^{-1}$ at 7 TeV and
...
\bibitem{ref:ATLAS-topCrossSection}ATLAS Collaboration, \Journal{\EPJC}{74}{3109}{2014}.

\bibitem{ref:CMS-topCrossSection}CMS Collaboration, \Journal{JHEP}{08}{029}{2016}.
