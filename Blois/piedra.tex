...
is measured~\cite{ATLAS-fb-asymmetry} using the 7~TeV pp LHC collision data
...
$\sin^2\theta_{\rm eff}^{\rm lept} = 0.2308 \pm 0.0005~({\rm stat.}) \pm 0.0006~({\rm syst.}) \pm 0.0009~({\rm PDF})$. The dominant uncertainty comes from knowdlege of the PDFs.
%
\begin{figure}
...
\bibitem{ATLAS-fb-asymmetry}ATLAS Collaboration, \Journal{JHEP}{09}{049}{2015}.
